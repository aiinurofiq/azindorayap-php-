...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Sarang Kompleks | AZINDORAYAP</title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper">
							<div class="section1">
                                <h4 class="s-property-title">Pembuatan Sarang yang Kompleks</h4>
                                <div class="s-property-content">
                                    <p>Rayap pekerja akan membuat sarang dengan menggunakan kombinasi antara lain tanah atau lumpur, kunyahan kayu, air liur dan kotoran rayap sendiri. Ada beberapa bagian-bagian pada sarang tersebut antara lain tempat hidup rayap, 
									penampungan air melalui kondensasi, ruang reproduksi atau untuk berkembang biak dan terkadang ada pula ruang penyimpanan makanan. Ruangan-ruangan pada sarang tersebut
									terhubung dengan dibuatnya labirin-labirin atau terowongan yang dapat memberikan udara ke dalam sarang dan membuat rayap dapat bergerak dengan lebih leluasa di dalam sarangnya. </p>
									<p>. Oleh karena itu, biasanya sarang rayap sering kali bertumpuk-tumpuk dan meninggi bahkan sampai muncul ke permukaan-permukan tanah, bahkan ada pula yang akhirnya membentuk gundukan besar.</p>
                                </div>
