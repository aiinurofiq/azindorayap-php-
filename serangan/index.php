...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Serangan Rayap | AZINDORAYAP</title>
	...
	<div class="navbarfixed">
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper"><br>
							<div class="section1">
                                <h4 class="s-property-title">Tanda-tanda Keberadaan Rayap</h4>
                                <div class="s-property-content">
                                    <p>Serangan rayap biasanya tidak terlihat hingga kemudian kita menyadari adanya kerusakan parah yang mereka timbulkan. serangga ini tinggal di lingkungan yang gelap, lembab dan terlindungi, sehingga sangat sulit ditemukan. 
									Begitu kita mengetahuinya, itu pun sudah terlambat sebab mereka sudah terlanjur merusak properti kita.</p>
									<p>Pada dasarnya, agak sulit untuk mengetahui serangan rayap sebab mereka membuat jalur 
									dengan menggerogoti kayu dari dalam, walaupun demikian ada beberapa tanda yang dapat menunjukkan keberadaan rayap.</p>
									<p><b>Berikut adalah tanda-tanda umum keberadaan rayap yang mungkin pernah Anda lihat (atau dengar) di sekitar rumah atau tempat usaha Anda.</b></p>
                                </div>
								<h4 class="s-property-title">Apa yang Harus Anda Cari?</h4>
                                <div class="s-property-content">
                                    <p><b>Tunnel atau alur rayap</b> - Subterranian / Rayap tanah membangun tabung penampungan yang terbuat dari lumpur, kotoran dan puing-puing sebagai jalur bolak balik menuju sumber makanan agar tidak terlihat. 
									Tabung ini biasanya seukuran koin dan umumnya ditemukan pada dinding eksterior dan interior yang mengarah ke titik masuk dari bangunan.</p>
                                
                                    <p><b>Kemunculan rayap terbang atau sejenis rayap yang merontokkan sayapnya</b> - Biasanya tanda pertama dari serangan rayap yang menjadi perhatian pemilik properti adalah kehadiran rayap terbang atau laron. 
									Tanda umum lainnya adalah sisa-sisa dari sayap yang rontok yang berkumpul di lantai dan ambang jendela. Walaupun rayap jenis ini kemungkinan 
									cepat menghilang setelah menemukan pasangan kawinnya, tanda-tanda seperti adanya kumpulan sayap yang identik tanpa tubuh merupakan pertanda kemunculan rayap terbang.</p>
									
									<p><b>Kayu yang terdengar berongga atau terasa tipis</b> - Rayap biasanya memakan kayu dari sebelah dalam ke luar dan meninggalkan kayu atau cat dengan lapisan tipis. Jadi, ketika Anda mengetuk atau menekan 
									area kayu yang diserang rayap, maka akan terdengar berongga atau terasa tipis karena sebagian (atau semua) isi kayu tersebut telah digerogoti oleh rayap.</p>
									
									<p><b>Pintu yang terasa ketat atau jendela yang sulit dibuka</b> - Dikarenakan rayap memakan kayu, kotoran atau 'lumpur' dari rayap tersebut membentuk suatu lingkungan protektif yang menyimpan panas dan kelembaban udara. 
									Hal ini menyebabkan kayu membengkak, sehingga akibatnya sulit untuk membuka atau menutup pintu dan jendela tersebut.</p>
									
									<p><b>Terowongan di kayu</b> - Juga dikenal sebagai 'galeri' dan cukup sulit untuk dilihat dari luar.</p>
									
									<p><b>Kotoran rayap</b> - Setelah memakan kayu, rayap kayu kering sering meninggalkan gundukan kotoran kasar berwarna coklat. Kotoran ini biasanya ditemukan di bawah kayu yang digerogoti.</p>
									<br><p align="right" style="font-size:small;">sumber : <i>http://rentokil.co.id</i></p>
								</div>
