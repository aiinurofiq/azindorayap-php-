			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="index.php" class=""><i class="lnr lnr-tag"></i> <span>Harga Pra</span></a></li>
					...
					<div class="panel panel-headline">
						<div class="panel-body">
								<?php
								  ...
								  ?>
							<form method="POST" action="ganti_pass.php?id_user=<?php echo $id_user;?>" name="form1" onSubmit="return cekInputan();">
							<table class="table">
                            <tr>
