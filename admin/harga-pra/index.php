...
<head>
	...
	function cekInputan(){
	var kondisi= true;
		if(document.form1.luas_pra.value == ""){
		...
		if(document.form1.harga_pra.value == ""){
	...
	<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="index.php" class="active"><i class="lnr lnr-tag"></i> <span>Harga Pra</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Harga Pra Kontruksi</h3>
					<div class="panel panel-headline">
						<div class="panel-body">
                            ...
                            <tr>
                            	<td width="40%">Luas</td>
                                <td width="20%"> <input type="text" class="form-control" name="luas_pra" placeholder="Masukkan Luas (m)"></td>
                                <td width="40%"><p id="luasmissing" style="color:black; font-size:small; visibility:hidden;">Masukkan Luas</p></td>
                            </tr>
                            <tr>
                            	<td>Harga (Garansi 5 tahun)</td>
                                <td> <input type="text" name="harga_pra" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" placeholder="Masukkan Harga 3 tahun"></td>
								<td width="40%"><p id="tigamissing" style="color:black; font-size:small; visibility:hidden;">Masukkan Harga</p></td>
                            </tr>
						  ...
						  <hr>
                            ...
                            <tr>
							 ...
							 <?php
								  ...
								  $query = "SELECT * FROM harga_pra"; // Query untuk menampilkan semua data siswa
								  $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
								  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
									
									echo "<tr>";
									echo "<td>".$data['luas_pra']."</td>";
									echo "<td>".$data['harga_pra']."</td>";
									echo "<td><a href='edit.php?id_harga_pra=".$data['id_harga_pra']."'>Edit</a></td>";
									echo "<td><a href='hapus.php?id_harga_pra=".$data['id_harga_pra']."'> Hapus</a></td>";
									echo "</tr>";
								  }
								  ?>
                            </table>
