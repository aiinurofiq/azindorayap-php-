...
<body>
		...
		$query = "SELECT * FROM harga_pra WHERE id_harga_pra='".$id_harga_pra."'";
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-body">
							<form method="POST" action="proses_edit.php?id_harga_pra=<?php echo $id_harga_pra; ?>" name="form1" onSubmit="return cekInputan();">
							<table class="table">
                            <tr>
                            	<td width="40%">Luas</td>
                                <td width="20%"> <input type="text" name="luas_pra" class="form-control" value="<?php echo $data['luas_pra']; ?>" placeholder="Masukkan Luas (m)"></td>
                                <td width="40%"><p id="luasmissing" style="color:black; font-size:small; visibility:hidden;">Masukkan luas dengan benar</p></td>
                            </tr>
                            <tr>
                            	<td>Harga 5 tahun</td>
                                <td><input type="text" name="limathn" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo $data['harga_pra']; ?>" placeholder="Masukkan Harga 5 tahun"></td>
