	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="../index.php" class=""><i class="lnr lnr-dice"></i> <span>Post</span></a></li>
						<li><a href="../pelanggan/index.php?hello=true" class=""><i class="lnr lnr-envelope"></i>Pelanggan  <span class='buble' id="jumlah"></span></a></li>
						<li><a href="../harga-pra" class=""><i class="lnr lnr-dice"></i> <span>Harga Pra</span></a></li>
						<li><a href="index.php" class="active"><i class="lnr lnr-file-empty"></i> <span>Harga Pasca</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-body">
							<form method="POST" action="proses_edit.php?id_harga=<?php echo $id_harga; ?>" name="form1" onSubmit="return cekInputan();">
							<table class="table">
                            <tr>
                            	<td width="40%">Luas</td>
                                <td width="20%"> <input type="text" name="luas" class="form-control" value="<?php echo $data['luas']; ?>" placeholder="Masukkan Luas (m)"></td>
                                <td width="40%"><p id="luasmissing" style="color:black; font-size:small; visibility:hidden;">Masukkan luas dengan benar</p></td>
                            </tr>
                            <tr>
                            	<td>Harga 3 tahun</td>
                                <td> <input type="text" name="tigathn" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo $data['hrg_3thn']; ?>" placeholder="Masukkan Harga 3 tahun"></td>
								<td width="40%"><p id="tigamissing" style="color:black; font-size:small; visibility:hidden;">Masukkan Harga 3 tahun</p></td>
                            </tr>
                            <tr>
                            	<td>Harga 5 tahun</td>
                                <td><input type="text" name="limathn" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo $data['hrg_5thn']; ?>" placeholder="Masukkan Harga 5 tahun"></td>
