        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper"><br>
							<div class="section1">
                                <h4 class="s-property-title">Azindorayap</h4>
                                <div class="s-property-content">
                                    <p>Azindo  berdiri sejak 2009, menangani hama komoditi beras, arsip, dan kayu, familiar dengan istilah fumigasi. Seiring banyaknya permintaan dan kebutuhan customer, 
									Azindo  merembah ke area pembasmian hama tikus, kecoa, dan rayap di kantor pemerintahan, bank, gudang, pabrik, restoran, hotel, apartemen, dan rumah hunian. </p>
									<p>Selain melayani pengendalian hama, Azindo juga menyalurkan tenaga Cleaning Service atau pembersihan, kerapian dan higenisasi baik indoor maupun outdoor 
									agar tercipta suasana yang comfortable dan menunjang aktifitas sehari-hari.</p>
									<p>Saat ini Azindo  dipercaya berbagai institusi ternama di Surabaya. Teknisi yang berpengalaman dan handal siap mempelajari berbagai jenis hama yang sedang mengganggu lingkungan, 
									sehingga mampu membasmi hama tepat sasaran. Metode kimia dan non kimia akan dikolaborasi menyesuaikan karakter hama yang sedang mengganggu lingkungan Anda. Hubungi kami kapan saja, kami siap membantu.</p>
                                </div>
								<h4 class="s-property-title">Mengapa Azindorayap ?</h4>
                                <div class="s-property-content">
                                    <p>Kebutuhan jasa pengandalian hama menjadi salah satu elemen penting bagi pemilik gedung atau bangunan. Hadirnya hama disuatu lingkungan menjadi hambatan yang mengakibatkan kerugian besar bagi manusia. 
									Hama-hama tersebut harus segera diatasi agar populasinya menurun kemudian dituntaskan dengan cara profesional agar tidak mengorbankan aset perusahaan.</p>
									<p>Salah satu solusi adalah menggunakan jasa Pest Control agar hama dapat ditangani dengan cara efektif dan efisien. Hama ditangani oleh tenaga ahli yang terdidik dan bersertifikat resmi 
									ASPPHAMI (Asosiasi Perusahaan Pengendalian Hama Indonesia). Anda dapat mempercayakan permasalahan hama pada kami.</p>
                                </div>
