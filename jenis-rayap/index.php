...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Jenis Rayap | AZINDORAYAP </title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper"><br>
							<div class="section1">
                                <h4 class="s-property-title">Spesies Rayap</h4>
                                <div class="s-property-content">
									<p>Rayap merupakan jenis serangga yang dianggap sebagai hama yang paling merusak di dunia. 
									Banyak struktural gedung dan bangunan rusak disebabkan oleh hama ini di setiap tahunnya dan mengakibatkan kerugian finansial yang besar.</p>
									<p>Terdapat 200 spesies rayap yang berbeda-beda di Jakarta, namun hanya segelintir yang menyebabkan masalah:</p>
									
									<ul>
										<li>Coptotermes gestroi</li>
										<li>Coptotermes curvignathus</li>
										<li>Coptotermes havilandi</li>
										<li>Coptotermes Kalshoven</li>
										<li>Coptotermes sepangensis</li>
										<li>Macrotermes gilvus</li>
										<li>Macrotermes pakistanicus</li>
										<li>Globitermes sulphureus</li>
										<li>Schedorhinotermes sp.</li>
										<li>Microcerotermes sp.</li>
										
									</ul>
									<p>Sekitar 90% dari kerusakan properti di Indonesia disebabkan oleh spesies Coptotermes sehingga rayap ini dilabeli sebagai "musuh nomor 1" di Indonesia</p>
