...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>AZINDORAYAP | Monitoring Rayap</title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper">
							<div class="section1">
                                <h4 class="s-property-title">Siklus Hidup Rayap</h4>
                                <div class="s-property-content">
                                    <p>Siklus hidup rayap dimulai dari Telur lunak berwarna jingga transparan yang selanjutnya akan berkembang menjadi larva.
									Larva kemudian akan tumbuh menjadi rayap muda yang disebut Nimfa (nymph). Ketika beranjak dewasa, rayap muda ini akan memilih peran mereka dalam koloni.</p>
                                </div>
								<h4 class="s-property-title">Menjadi rayap pekerja</h4>
                                <div class="s-property-content">
                                    <p>Peran pertama adalah Rayap Pekerja, dengan jumlah terbanyak di koloni. Tugas mereka mencari dan menyimpan makanan, merawat induk dan larva, membangun & memperbaiki sarang. 
									Rayap dari kasta inilah yang dapat merusak bangunan kayu karena memiliki kemampuan mencerna selulosa dalam kayu, dimana hasil pencernaan 
									akan dimuntahkan dan dipersembahkan sebagai makanan induk, prajurit dan para larva. Jenis rayap paling merusak adalah rayap Formosa karena memiliki koloni sangat besar.</p>
                                </div>
								<h4 class="s-property-title">Menjadi rayap prajurit</h4>
                                <div class="s-property-content">
                                    <p>Peran lainnya adalah menjadi Rayap Prajurit yang bertugas menjaga sarang dan keseluruhan koloni. Kasta prajurit memiliki spesialisasi anatomi dan perilaku untuk melawan serangan musuh utama mereka, semut. Rayap jenis ini memiliki rahang yang besar sehingga mereka tidak mampu makan sendiri. Mereka bergantung pada rayap pekerja untuk menyediakan mereka dengan makanan muntahan. 
									Rayap prajurit dan rayap pekerja sama-sama tidak memiliki mata dan biasanya hidup maksimal dua tahun.</p>
                                </div>
								<h4 class="s-property-title">Menjadi Rayap Reproduksi (Alates),</h4>
                                <div class="s-property-content">
                                    <p>Rayap-rayap ini adalah calon raja dan ratu koloni baru nantinya. Untuk menjadi laron, nimfa rayap harus melalui proses metamorfosis tidak sempurna. Bentuk tubuh mereka saat ini masih ramping dan hanya mereka yang punya sayap di kerajaan rayap. Sayap ini diperlukan untuk berpindah tempat untuk membangun koloni baru, dua pasang sayap dengan ukuran sama akan muncul dari punggung mereka. 
									Karena hal inilah rayap diklasifikasikan dalam ordo Isoptera ( iso = sama dan pteron = sayap).</p>
									<p>Rayap reproduksi ini sering kita sebut sebagai laron dan muncul sebelum hujan. Rayap reproduksi memiliki mata yang tidak dimiliki oleh rayap pekerja atau rayap prajurit. Bentuk tubuh mereka yang indah untuk golongan rayap (ramping dan bersayap) tidak akan bertahan lama. Sayap mereka sangat rapuh, dan akan segera rontok begitu mereka telah menemukan tempat untuk membangun koloni baru. 
									Jika terpilih menjadi ratu, tubuh laron betina tidak akan ramping lagi dan akan mengalami obesitas, karena tujuan hidupnya hingga ajal adalah bertelur untuk koloni.</p>
									<p>Setelah tiba di calon tempat tinggal baru, rayap reproduksi terpilih akan menjadi Ratu & Raja dalam koloni. Dimana dalam koloni hanya terdapat satu raja dan satu ratu. Ratu rayap merupakan serangga dengan umur terpanjang di dunia, ratu rayap dapat hidup 50 tahun pada kondisi ideal. Kebanyakan serangga hanya hidup dalaman hitungan bulan atau hari, 
									bahkan lalat capung (mayfly) yang merupakan serangga dengan umur terpendek di dunia hanya hidup dalam hitungan jam.</p>
									<p>Saat kemampuan bertelur ratu menurun, fungsinya dalam hal reproduksi akan dibantu rayap reproduksi untuk meringankan beban ratu. Rayap reproduksi yang dimaksud adalah rayap-rayap reproduksi (laron) yang sebelumnya gagal terpilih menjadi ratu dan raja koloni baru. Meskipun rayap reproduksi bertelur lebih sedikit dari ratu, jumlah mereka dalam koloni bisa mencapai ratusan. Kontribusi mereka untuk 
									kapasitas bertelur koloni dapat menjadi luar biasa dan ketika ratu meninggal mereka dapat mengambil alih total tugas reproduksi.</p>
                                </div>
