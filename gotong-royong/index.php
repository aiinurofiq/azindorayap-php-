...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Bergotong - Royong mengumpulkan makanan | AZINDORAYAP</title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper">
							<div class="section1">
                                <h4 class="s-property-title">Bergotong Royong Mengumpulkan Makanan</h4>
                                <div class="s-property-content">
                                    <p>Rayap akan bekerja sama mengumpulkan makanan setiap harinya, pastinya hal tersebut dilakukan oleh rayap pekerja. 
									Makanan yang telah didapat biasanya akan dikumpulkan ke dalam suatu rongga atau ruangan khusus penyimpan makanan. 
									Makanan-makanan ini nantinya akan dikonsumsi oleh semua anggota rayap. Rayap-rayap pekerja juga akan menimbun persediaan makanan mereka 
									sebagai bekal apabila musim dingin tiba dan tidak memungkinkan mereka untuk mencari makanan karena terbatasnya sumber makanan akibat hujan. 
									Jamur yang berada di lingkungan tempat tinggal rayap biasanya adalah sumber utama makanan mereka.</p>
