...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Pengendalian Rayap | AZINDORAYAP</title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper"><br>
							<div class="section1">
                                <h4 class="s-property-title">Pengendalian Rayap</h4>
                                <div class="s-property-content">
									<p><b>Tahukah Anda bahwa rayap dapat menurunkan nilai properti Anda sampai lebih dari 25 persen?</b></p>
									<p>Serangan rayap dapat menyebabkan biaya perbaikan mahal dan rasa frustrasi berkepanjangan. Jika Anda menemukan tanda-tanda infestasi rayap di tempat tinggal Anda. Anda mungkin memerlukan seseorang yang berpengalaman dan terlatih secara 
									profesional untuk dapat mengembalikan rasa kenyamanan dan keamanan Anda kembali. Teknisi kami senantiasa dibekali program pelatihan secara berkala dan berkesinambungan agar dapat memberikan solusi pengendalian rayap yang efektif dan up to date.</p>
                                </div>
								<h4 class="s-property-title">Monitoring & Pengumpanan</h4>
                                <div class="s-property-content">
                                    <p>Sebuah solusi holistik yang menggunakan unit monitoring ditempatkan hampit tidak terlihat atau tidak menarik perhatian diletakan di sekeliling bangunan Anda. 
									Teknisi ahli kami akan memantau aktivitas rayap di tempat-tempat ini secara rutin dan ketika ditemukan adanya aktivitas rayap,
									umpan rayap akan segera dipasang. Umpan ini mengandung suatu bahan aktif yang menghambat pertumbuhan rayap. Ketika umpan terbagi-bagi dan tersebar, 
									ia akan mengeliminasi anggota koloni secara bertahap sampai koloni tersebut musnah.</p>
								</div>
								<h4 class="s-property-title">Pengendalian Rayap dengan Termitisida Cair</h4>
                                <div class="s-property-content">
                                    <p>Metode pengendalian rayap dengan metode konvensional yang menggunakan termitisida cair sudah membuktikan keampuhannya. Metode ini bisa digunakan untuk mengatasi masalah rayap atau sebagai perlindungan dari serangan rayap.
									Kami juga mempunyai pilihan lain untuk pengendalian rayap pra konstruksi yaitu metode Soil Pre Treatmen / SPT, metode ini memberikan garansi dengan periode lebih panjang dan juga keuntungan yang lain.</p>
