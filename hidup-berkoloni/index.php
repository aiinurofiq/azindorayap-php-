...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Hidup Berkoloni | AZINDORAYAP </title>
        ...
        <!-- deskripsi -->
					<div class="container">
						<div class="single-property-wrapper">
							<div class="section1">
                                <h4 class="s-property-title">Rayap Hidup Berkoloni</h4>
                                <div class="s-property-content">
                                    <p>Sama seperti lebah ternyata kehidupan rayap yang berkoloni memiliki kedudukan masing-masing dalam suatu kelompok. Pada sistem sosialisasinya ada raja dan ratu rayap yang memiliki tugas untuk berkembang biak atau dalam kata lain mereka 
									bertugas untuk menetaskan calon-calon rayap lainnya. Pemimpin atau raja dan ratu rayap biasanya memiliki perbedaan yang mencolok dari yang lainnya, yaitu ukuran tubuh yang lebih besar. Pemimpin rayap akan selalu dilindungi dan dihormati oleh 
									kelompok rayap tersebut. Selain raja dan ratu ada kelompok rayap tersebut juga terbagi menjadi bagian lainnya yakni kelompok prajurit dan kelompok pekerja.</p>
									...
									<p>Kelompok rayap prajurit memiliki ukuran yang tentunya lebih kecil dari pemimpinnya. Keunikan yang dimiliki kelompok rayap prajurit ini mereka memiliki capit atau sengatan pada bagian kepala yang digunakan sebagai senjata membela diri dan melawan musuh yang membahayakannya. Pada kelompok pekerja memiliki ciri ukuran tubuh lebih kecil dan berwarna putih. 
									Kelompok rayap pekerja ini merupakan yang paling banyak dari lainnya. Mereka akan bertugas mencari makanan dan membentuk sarang pada kayu atau tanah.</p>
